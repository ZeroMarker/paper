...
华林问题询问每个正整数是否可以表示为固定个数的 $k$ 次幂之和\cite{nathanson1996additive}。哥德巴赫猜想的方法被用于研究素数版本的华林问题。
...
\begin{theorem}[Baker--Harman--Pintz, 2001]
    对充分大的 $x$，区间 $[x,\ x + x^{0.525}]$ 中必存在素数。
\end{theorem}

在黎曼猜想下该指数可以改进到 $1/2 + \epsilon$；优化指数本身仍是活跃的研究方向。
